...
\usepackage{enumitem}
\usepackage[style=ieee, backend=biber, sorting=ydnt, maxnames=99]{biblatex}
...
%   url          = false,
% ]{biblatex}
\setlist{topsep=-5pt, leftmargin=*, noitemsep, after=\vspace{0.5\baselineskip}}
% \usepackage{paralist}
\newcommand{\tab}[1]{\hspace{.2667\textwidth}\rlap{#1}}
\newcommand{\itab}[1]{\hspace{0em}\rlap{#1}}
\name{Nicholas Rober} % Your name
\address{nrober@mit.edu \\ nrober1122.github.io} % Your address
...
% \input{sections/mentorship_experience.tex}
